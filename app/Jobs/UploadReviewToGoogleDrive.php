...
class UploadReviewToGoogleDrive implements ShouldQueue
{
    ...
    public function __construct($review_id, $base64Image)
    {
    ...
    public function handle()
    {
        ...
        $imageReview = new ReviewImage();
        $imageReview->review_id = $this->review_id;
        $imageReview->image = $imageLink;
        $imageReview->save();
    }
}
